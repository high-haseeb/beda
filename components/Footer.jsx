...
const Footer = () => {
    return (
        <div className="w-screen flex justify-center items-center h-auto bg-white/50 py-10 mt-40">
            <div className="flex lg:flex-row flex-col w-4/5 gap-10">
                ...
                <span className="text-left font-light text-xl">Difference in Beda acknowledges Aboriginal and Torres Strait Islander peoples as the traditional
...
and spiritual connection to country and waters.</span>
                ...
                <span className="text-left font-light text-xl">Difference in Beda acknowledges remain committed to embracing and celebrating diversity and
