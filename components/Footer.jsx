        ...
        <div className="w-screen flex justify-center items-center h-auto bg-white/50 py-10 mt-40" id="footer">
            <div className="flex lg:flex-row flex-col w-4/5 gap-10">
                <div className=" w-full lg:w-1/3 flex flex-col justify-center items-start lg:p-8 gap-8">
                    ...
                    <button className="capitalize rounded-lg bg-[blue] lg:w-1/2 p-3 text-white text-base lg:text-xl font-semibold">
                        Book Appointment
                    </button>
                </div>
                ...
                <div className="flex w-full lg:w-1/3 justify-start mt-8">
                    <div className="w-full flex flex-col gap-5">
                        <Image src={"/flags/flag 1.jpg"} width={200} height={200} className="object-cover lg:w-20 w-10" />
                        <span className="text-left font-light lg:text-xl text-xs">Difference in Beda acknowledges Aboriginal and Torres Strait Islander peoples as the traditional
                ...
                <div className="flex w-full lg:w-1/3 justify-start mt-8">
                    <div className="w-full flex flex-col gap-5">
                        <div className="flex w-full gap-2">
                            <Image src={"/flags/flag 2.jpg"} width={200} height={200} className="object-cover lg:w-20 w-10" />
                            <Image src={"/flags/flag 3.jpg"} width={200} height={200} className="object-cover lg:w-20 w-10" />

                        </div>

                        <span className="text-left font-light lg:text-xl text-xs">Difference in Beda acknowledges remain committed to embracing and celebrating diversity and
